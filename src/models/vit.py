# https://github.com/dqj5182/ViT-PyTorch/blob/main/model/vit/vit.py
...
class ViT(nn.Module): # Done
    ...
    def _init_weights(self):
        # Initialize Weights for Linear Projection of Flattened Patches
        ...
        # Initialize Weights for Positional Embedding
